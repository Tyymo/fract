// ==UserScript==
// @name         !BlumFarm!
// @Donate       0x07e5846470259193380c59a95465b9fc791e2f1e
// @version      Infinity_Updated
// @namespace    Shadeias
// @match        https://telegram.blum.codes/*
// @grant        none
// @icon         https://cdn.hamsterkombat.io/achievements/profit_per_hour_5.webp
// ==/UserScript==
...
let GAME_SETTINGS = {
    clickPercentage: {
        ...
        other: Math.floor(Math.random() * (90 - 80 + 1)) + 80,
    },
    autoClickPlay: false,
};
...
try {
    ...
    async function handleGameElement(element) {
        ...
        switch (assetType) {
            ...
            case "FREEZE":
                ...
                break;
            case "OTHER":
                if (randomValue < GAME_SETTINGS.clickPercentage.other) {
                    await clickElementWithDelay(element);
                }
                break;
            default:
    ...
    OutGamePausedTrue.href = atob('aHR0cHM6Ly90Lm1lL1R5eW1v');
    OutGamePausedTrue.textContent = atob('U2hhZGVpYXM=');
